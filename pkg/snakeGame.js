import { rnd } from './snippets/snakeGame-98ac302e8caad7bf/www/utils/rnd.js';
...
/**
*/
export const GameStatus = Object.freeze({ Won:0,"0":"Won",Loss:1,"1":"Loss",Played:2,"2":"Played", });
/**
*/
export class World {
    ...
    */
    game_stastus_text() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.world_game_stastus_text(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_rnd_c0dcf8754cef639a = function(arg0) {
